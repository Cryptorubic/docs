...
[___Rubic aims to operate as a secure, sustainable Cross-Chain Tech Aggregator that anyone can rely on to exchange and move cryptocurrencies across chains. In the interest of further security improvement, we are launching the Rubic Bug Bounty Program with Immunefy.___](https://immunefi.com/bounty/rubic/)
