---
title: "Endpoints for deposit providers: quoteDepositTrades & swapDepositTrade"
description: "These are specific endpoints where only deposit providers are available: ChangeNOW, Changelly, SimpleSwap & Exolix."
---

<Tip>
   There are no checks for approval, native token balance, or overall balance. Wallet connection is not required. 
</Tip>
