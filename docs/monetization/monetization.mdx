...
<Tip>In case models for on-chain and cross-chain transactions are different, you should send us two wallet addresses. One will be used for on-chain commission receiving, the second one for cross-chain.</Tip>