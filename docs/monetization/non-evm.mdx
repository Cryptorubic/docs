---
Title: 'Fee Sharing from non-EVM chains via ChangeNOW'
Icon: 'bitcoin-sign'
---

<Note>Fee sharing from non-EVM chains is currently available only via the ChangeNOW provider. Fees are shared for cross-chain swaps across all networks supported by ChangeNOW, including both EVM and non-EVM networks.</Note>
...
<Note>Fees for all networks are credited in the **Binance Smart Chain (BNB Chain)** network, in **USDT**.</Note>
