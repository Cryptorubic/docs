---
title: "Overview"
description: "Rubic API is a unified interface for building on-chain and cross-chain swap integrations. It allows applications to discover available routes, calculate swap results, execute swaps, and track transaction status across multiple blockchains and providers.
