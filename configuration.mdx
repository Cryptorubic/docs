...
| `apiKey` | `string` | | `''` | API key for the Rubic API. Get one at [app.rubic.exchange](https://t.me/RubicPartnership) |
| `integratorAddress` | `object` | | See below | Wallet addresses that collect integrator fees |
...
| `domain` | `string` | | `api-v2.rubic.exchange/api` | API domain. Override for staging/self-hosted deployments |
